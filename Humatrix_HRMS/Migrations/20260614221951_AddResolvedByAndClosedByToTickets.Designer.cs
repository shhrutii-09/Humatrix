...
namespace Humatrix_HRMS.Migrations
{
    ...
    [Migration("20260614221951_AddResolvedByAndClosedByToTickets")]
    partial class AddResolvedByAndClosedByToTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.DocumentExpiryAlert", b =>
                {
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.DocumentHistory", b =>
                {
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.DocumentType", b =>
                {
                    ...
                    b.Property<bool>("IsEmployeeUploadAllowed")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHRUploadAllowed")
                        .HasColumnType("bit");

                    b.Property<bool>("IsMandatory")
                        .HasColumnType("bit");

                    b.Property<bool>("IsOrganizationGenerated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.OrgDocumentHistory", b =>
                {
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.OrgGeneratedDocument", b =>
                {
                    ...
                    b.Property<string>("AcknowledgedByEmployeeId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AcknowledgmentRemarks")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("OrgGeneratedDocuments");
                });
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("LastBirthdayNotificationSent")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("OnboardingDocumentsProcessed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.EmployeeExit", b =>
                {
                    ...
                    b.Property<DateTime?>("AccessRevokedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("AssetsReturnedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ExitInterviewFeedback")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("ExperienceLetterIssued")
                        .HasColumnType("bit");

                    b.Property<decimal?>("FullFinalAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("KnowledgeTransferDetails")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("NoDuesCleared")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("NoDuesClearedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("RelievingLetterIssued")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ExitInterviewerEmployeeId");
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.LeaveRequest", b =>
                {
                    ...
                    b.Property<bool>("LeaveSanctionLetterIssued")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.TaskItem", b =>
                {
                    ...
                    b.Property<bool>("CompletionCertificateIssued")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.EmployeeDocument", b =>
                {
                    b.HasOne("Humatrix_HRMS.Models.Documents.DocumentType", "DocumentType")
                        .WithMany("Documents")
                    ...
                    b.HasOne("Humatrix_HRMS.Models.Documents.EmployeeDocument", "PreviousDocument")
                        .WithMany()
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.OrgDocumentHistory", b =>
                {
                    b.HasOne("Humatrix_HRMS.Models.Documents.OrgGeneratedDocument", "Document")
                        .WithMany("History")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.Documents.OrgGeneratedDocument", b =>
                {
                    ...
                    b.HasOne("Humatrix_HRMS.Models.Documents.OrgGeneratedDocument", "PreviousDocument")
                        .WithMany()
                        .HasForeignKey("PreviousDocumentId");
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.EmployeeExit", b =>
                {
                    b.HasOne("Humatrix_HRMS.Models.Employee", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedByEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Humatrix_HRMS.Models.Employee", "CancelledBy")
                        .WithMany()
                        .HasForeignKey("CancelledByEmployeeId");

                    b.HasOne("Humatrix_HRMS.Models.Employee", "CompletedBy")
                        .WithMany()
                    ...
                    b.HasOne("Humatrix_HRMS.Models.Employee", "ExitInterviewer")
                        .WithMany()
                        .HasForeignKey("ExitInterviewerEmployeeId");
            ...
            modelBuilder.Entity("Humatrix_HRMS.Models.SupportTicket", b =>
                {
                    b.HasOne("Humatrix_HRMS.Models.Employee", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Humatrix_HRMS.Data.ApplicationUser", "ClosedBy")
                        .WithMany()
                    ...
                    b.HasOne("Humatrix_HRMS.Data.ApplicationUser", "ResolvedBy")
                        .WithMany()
